          ...
          <div>
            <div className="flex flex-col">
              ...
              <input
                ...
                className=" h-12 border-[1px] text-[#666666] outline-none rounded-md text-[16px] px-[16px] py-[14px]"
                {...register("address")}
              />
            ...
            <div className=" flex flex-col">
              ...
              <input
                ...
                className=" h-12 border-[1px] text-[#666666] outline-none rounded-md text-[16px] px-[16px] py-[14px] mt-[6px]"
                type="email"
                {...register("email")}
              />
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                {...register("phone")}
              />
              {errors.email && <p className="error">{errors.phone.message}</p>}
            </div>
          </div>
          ...
          <div className="flex xl:flex-row flex-col xl:mt-0 mt-[23px] gap-[15px]">
            ...
            <div className="flex flex-col w-full">
              ...
              <input
                id="address"
                placeholder="1425 park"
                className=" w-full h-12 border-[1px] text-[#666666] outline-none rounded-md text-[16px] px-[16px] py-3"
                {...register("address")}
              />
              {errors.name && <p className="error">{errors.address.message}</p>}
            </div>
