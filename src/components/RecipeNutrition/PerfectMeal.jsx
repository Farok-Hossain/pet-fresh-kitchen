      ...
      <CommonWrapper>
        <div className="flex xl:flex-row flex-col xl:gap-[27px] items-center">
          ...
          <div>
            ...
            <p className="text-white font-normal xl:leading-8 xl:text-[22px] lg:px-10 xl:text-start text-center mb-8">Every PEDIGREE recipe is crafted with high-quality ingredients and expertly designed to deliver professional nutrition, supporting your dog&apos;s health, vitality, and helping them thrive to reach their full potential.</p>
