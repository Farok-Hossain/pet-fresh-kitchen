...
const ChickenChow = () => {
  ...
  return (
    <div className="lg:pt-[120px] pt-16">
      <RecipeDetails
        title="Chicken Chow"
        description="Ingredients: how , Tricalcium, Salmon Oil, Taurine, Zinc Gluconate, Vitamin E Supplement, Copper Acid Chelate, Manganese Amino Acid Chelate, Vitamin D3, Vitamin B2, Vitamin B1, Vitamin B6, Potassium Iodide."
