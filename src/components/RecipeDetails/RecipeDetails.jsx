  ...
  return (
    <CommonWrapper>
      ...
      <div className="xl:mt-[210px] mt-8">
        ...
        <li className="text-textGraySm xl:text-xl text-center xl:text-start font-normal xl:mb-8 mb-2">
          {" "}
        ...
        <h3 className="text-textGray xl:text-[32px] text-xl text-center xl:text-start font-semibold leading-[44px] xl:mb-5 ">Chicken & Rice Delight:</h3>
        <div className="border-b-[2px] border-[#383838] xl:leading-8 mb-5"></div>
        <p className="text-textGraySm xl:text-xl text-center xl:text-start font-normal xl:mb-8 mb-5">Ingredients: how , Tricalcium Phosphate, Salmon Oil, Salt, Taurine, Zinc Gluconate, Vitamin E Supplement, Ferrous Sulfate, Copper Amino Acid Chelate, Manganese Amino Acid Chelate, Vitamin D3, Vitamin B2, Vitamin B1, Vitamin B6, Potassium Iodide.</p>

        <h3 className="text-textGray xl:text-[32px] text-xl xl:font-semibold font-medium xl:leading-[44px] xl:mb-5 mb-2 text-center xl:text-start">
          Why It’s Greate
        </h3>
        <div className="border-b-[2px] border-[#383838] leading-8 mb-5"></div>
        ...
        <h3 className="text-textGray xl:text-[32px] text-xl xl:font-semibold font-medium xl:leading-[44px] xl:mb-5 mb-2 text-center xl:text-start ">Nutrition Information (Placeholder Values):</h3>
        <div className="border-b-[2px] border-[#383838] leading-8 mb-5"></div>
        ...
        <h3 className="text-textGray xl:text-[32px] text-xl xl:font-semibold font-medium xl:leading-[44px] xl:mb-5 mb-2 text-center xl:text-start">Veggie Feast Bowl</h3>
        <div className="border-b-[2px] border-[#383838] leading-8 mb-5"></div>

        <p className="text-textGraySm xl:text-xl text-center xl:text-start font-normal xl:mb-8 mb-5">Ingredients: Paneer, Brown Rice, Pumpkin, Green Peas, Carrots, Sweet Potatoes, Spinach, Turmeric, Coconut Oil, Flaxseeds, Tricalcium Phosphate, Iodized Salt, Vitamin Supplements, Zinc Gluconate, Iron Supplements.</p>
