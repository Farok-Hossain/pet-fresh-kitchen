        ...
        >
          ...
          <div className="container  flex flex-col xl:flex-row justify-between items-center gap-6 xl:gap-[130px]">
            <div className="xl:min-w-[800px]">
                <h2 className="text-2xl xl:text-[64px] text-textGray xl:leading-[80px] text-center font-semibold  mb-5 ">Premium Nutrition for Healthier, Happier Dogs</h2>
            ...
            {/* image here  */}
            <div className="xl:min-w-[670px] xl:h-[525px]">
