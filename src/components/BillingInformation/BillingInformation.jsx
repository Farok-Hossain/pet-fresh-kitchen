        ...
        <div className="xl:pl-6 xl:mt-6 mt-3">
          <form className=" xl:mt-[50px] space-y-4">
            ...
            <div className="flex flex-col xl:flex-row w-full gap-4">
              ...
              <div className="w-full">
                <div className="flex flex-col xl:flex-row w-full gap-4">
                  <CommonSelectField width="xl:w-[176px]" options={states} label="States" />
          ...
          <div className="flex gap-[6px] mt-5 mb-10">
            ...
            <div className="border-[1px] text-[#E5E5E5]"></div>
            <div>
                <h3 className="text-xl text-center xl:text-start font-medium leading-[21px] mt-5">Additional Info</h3>
            </div>
            ...
            <div className="border-[1px] text-[#E5E5E5] rounded-md">
                <h5 className="text-[14px] pt-[14px] pl-[16px] xl:pr-[465px] xl:pb-[65px] pb-8 text-[#999] xl:leading-[21px] ">Notes about your order, special notes for delivery</h5>
            </div>
        </div>
      </div>
        </div>
